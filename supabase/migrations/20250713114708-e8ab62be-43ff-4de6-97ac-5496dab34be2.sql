...
ON CONFLICT (device_id, user_code) DO UPDATE SET
...
-- Add sample alarm history for testing
INSERT INTO alarms (device_id, user_code, smoke, temperature, battery, alarm_type, location) VALUES 
